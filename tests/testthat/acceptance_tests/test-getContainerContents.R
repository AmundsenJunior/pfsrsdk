...
test_that(paste("test getContainerContents() on semantic version:", con$coreApi$semVer), {
...
test_that(paste("getContainerContents returns successful with fullMetadata on semantic version:", con$coreApi$semVer), {
